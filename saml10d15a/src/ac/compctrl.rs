...
impl MUXNEG_R {
    ...
    #[doc = "Checks if the value of the field is `DAC_OPAMP`"]
    #[inline(always)]
    pub fn is_dac_opamp(&self) -> bool {
        *self == MUXNEG_A::DAC_OPAMP
    }
}
...
impl<'a> MUXNEG_W<'a> {
    ...
    #[inline(always)]
    pub fn dac_opamp(self) -> &'a mut W {
        self.variant(MUXNEG_A::DAC_OPAMP)
    }
    #[doc = r"Writes raw bits to the field"]
    #[inline(always)]
    pub fn bits(self, value: u8) -> &'a mut W {
